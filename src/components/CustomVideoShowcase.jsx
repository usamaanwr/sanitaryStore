            ...
            <div className="max-w-7xl mx-auto w-full">
                ...
                <div className="flex flex-col items-start mb-12 gap-4">
                    ...
                    <div>
                        ...
                        <h2 className="text-3xl md:text-4xl font-semibold text-dark tracking-tight uppercase leading-none mb-2">
                            Craftsmanship <span className="text-primary font-bold">In Motion</span>
                        </h2>
                    </div>

                    <p className="text-[#B85C38] text-xs md:text-sm font-semibold max-w-xl text-left leading-relaxed">
